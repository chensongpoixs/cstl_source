...
template <class V, class K, class HF, class ExK, class EqK, class A>
void hashtable<V, K, HF, ExK, EqK, A>::erase_bucket(const __size_type__ n, 
...
template <class V, class K, class HF, class ExK, class EqK, class A>
void 
hashtable<V, K, HF, ExK, EqK, A>::erase_bucket(const __size_type__ n, __node__* last)
{
  node* cur = buckets[n];
  while (cur != last) {
    node* next = cur->next;
